 jQuery(document).ready(function($) {
   ...
   $('.submitregister').click(function(e){
     ...
     var lettas = /^[a-zA-Z]+$/;
     if(sname == null || sname.match(lettas)  == null){
       $('.form-control').addClass('form-error');
       $('.error_surname').html('sur name is required as Alphabet'); 
       theerrortag = true;
     }
     ...
     if(gname == null || gname.match(lettas2) == null){
       $('.form-control').addClass('form-error');
       $('.error_givenname').html('given name is required as Alphabet'); 
       theerrortag = true;
     }
    ...
    //  }
     ...
     if(placeofresidence){}else{
       $('.form-control').addClass('form-error');
       $('.error_placeofresidence').html('Provide place of residence');
       theerrortag = true;
     }
   ...
   // reset user register
   $('.resetuserregister').click(function(e){
      e.preventDefault();
      $('.sendformuser')[0].reset();
   });  
   ...
   $('.submituserregister').click(function(e){
    ...
    //  }
     ...
     if(gname == null || gname.match(lettas2) == null){
       $('.form-control').addClass('form-error');
       $('.error_lastname').html('given name is required as Alphabet'); 
       theerrortag = true;
     }
    ...
    //  }
     ...
     if(occupation ){}else{
       $('.form-control').addClass('form-error');
       $('.error_occupation').html('Provide a user occupation');
       theerrortag = true;
     }
